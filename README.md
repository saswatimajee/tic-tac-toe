...
## This game is made using Java and Java Swing features.

Tic-tac-toe is a paper-and-pencil game for two players on a 3x3 grid. Players take turns marking empty squares with either an X or an O, and the first player to get three of their marks in a row wins. A row can be horizontal, vertical, or diagonal. The game ends in a tie if all nine squares are filled without a winner. 
